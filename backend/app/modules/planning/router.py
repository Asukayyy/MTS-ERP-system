...
业务路由请在本文件中继续添加，统一前缀 `/api/v1/planning` 由 `app/main.py` 注入。
"""

from fastapi import APIRouter

from app.modules.planning.schemas import HealthResponse
...
@router.get("/health", response_model=HealthResponse, summary="planning 模块健康检查（占位）")
